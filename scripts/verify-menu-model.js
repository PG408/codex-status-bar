...
const checks = [
  ...
  ["Swift does not treat transient ChatGPT view activity as Side Chat closure", !swift.includes("ChatGPTActivityLogMonitor") && !swift.includes("isClosedSideChatSession") && !swift.includes("thread_stream_view_activity_changed")],
