...
const checks = [
  ...
  ["Swift passes one Codex liveness snapshot through evaluation", swift.includes("func evaluate(codexRunning: Bool)") && swift.includes("func cleanupDeadSessions(codexRunning: Bool)") && swift.includes("func evaluateAutoExit(codexRunning: Bool)")],
